...
public class RegistrationServlet extends HttpServlet {
        public void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
            ...
            if (clientDao.getClient(req.getParameter("user_name")) == null) {
                ...
                if (req.getParameter("user_name") != null) client.setEmail(req.getParameter("user_name"));
                if (req.getParameter("first_name") != null) client.setName(req.getParameter("first_name"));
                if (req.getParameter("last_name") != null) client.setSurname(req.getParameter("last_name"));
                if (req.getParameter("pass_word") != null) client.setPassword(req.getParameter("pass_word"));
